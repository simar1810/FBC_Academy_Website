        ...
        <>
          ...
          <main className="pt-24 min-h-screen">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-12">
              <h1 className="text-4xl md:text-6xl font-playfair font-bold mb-4">Real <span className="text-[#1142D4]">Transformations</span></h1>
              <p className="text-gray-600 max-w-2xl mx-auto text-lg">The Proof of the System. Results That Speak for Themselves. Every story here is a reminder of what minimalist effort and absolute consistency can achieve.</p>
            </div>
            <BodyJournal/>
            <LimitedAvailability/>
            <Footer/>
